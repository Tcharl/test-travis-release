...
describe('Service Tests', () => {
    ...
    describe('EntityWithServiceImplAndPagination Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EntityWithServiceImplAndPaginationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/entity-with-service-impl-and-paginations/' + 123);
            });
            it('should return EntityWithServiceImplAndPagination', () => {

                let entity: EntityWithServiceImplAndPagination;
                service.find(123).subscribe((_entity: EntityWithServiceImplAndPagination) => {
                    entity = _entity;
                });
