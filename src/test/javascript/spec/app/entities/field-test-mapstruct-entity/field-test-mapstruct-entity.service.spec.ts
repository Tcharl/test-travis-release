...
describe('Service Tests', () => {
    ...
    describe('FieldTestMapstructEntity Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FieldTestMapstructEntityService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/field-test-mapstruct-entities/' + 123);
            });
            it('should return FieldTestMapstructEntity', () => {

                let entity: FieldTestMapstructEntity;
                service.find(123).subscribe((_entity: FieldTestMapstructEntity) => {
                    entity = _entity;
                });
