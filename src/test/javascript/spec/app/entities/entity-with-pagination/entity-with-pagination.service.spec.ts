...
describe('Service Tests', () => {
    ...
    describe('EntityWithPagination Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EntityWithPaginationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/entity-with-paginations/' + 123);
            });
            it('should return EntityWithPagination', () => {

                let entity: EntityWithPagination;
                service.find(123).subscribe((_entity: EntityWithPagination) => {
                    entity = _entity;
                });
