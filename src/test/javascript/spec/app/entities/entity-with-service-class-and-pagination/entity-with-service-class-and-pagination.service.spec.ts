...
describe('Service Tests', () => {
    ...
    describe('EntityWithServiceClassAndPagination Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EntityWithServiceClassAndPaginationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/entity-with-service-class-and-paginations/' + 123);
            });
            it('should return EntityWithServiceClassAndPagination', () => {

                let entity: EntityWithServiceClassAndPagination;
                service.find(123).subscribe((_entity: EntityWithServiceClassAndPagination) => {
                    entity = _entity;
                });
