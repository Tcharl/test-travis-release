...
describe('Service Tests', () => {
    ...
    describe('FieldTestPagerEntity Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FieldTestPagerEntityService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/field-test-pager-entities/' + 123);
            });
            it('should return FieldTestPagerEntity', () => {

                let entity: FieldTestPagerEntity;
                service.find(123).subscribe((_entity: FieldTestPagerEntity) => {
                    entity = _entity;
                });
