...
describe('Service Tests', () => {
    ...
    describe('EntityWithServiceClassAndDTO Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EntityWithServiceClassAndDTOService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/entity-with-service-class-and-dtos/' + 123);
            });
            it('should return EntityWithServiceClassAndDTO', () => {

                let entity: EntityWithServiceClassAndDTO;
                service.find(123).subscribe((_entity: EntityWithServiceClassAndDTO) => {
                    entity = _entity;
                });
