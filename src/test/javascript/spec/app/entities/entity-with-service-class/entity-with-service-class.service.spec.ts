...
describe('Service Tests', () => {
    ...
    describe('EntityWithServiceClass Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EntityWithServiceClassService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/entity-with-service-classes/' + 123);
            });
            it('should return EntityWithServiceClass', () => {

                let entity: EntityWithServiceClass;
                service.find(123).subscribe((_entity: EntityWithServiceClass) => {
                    entity = _entity;
                });
