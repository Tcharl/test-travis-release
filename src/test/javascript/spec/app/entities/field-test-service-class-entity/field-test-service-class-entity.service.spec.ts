...
describe('Service Tests', () => {
    ...
    describe('FieldTestServiceClassEntity Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FieldTestServiceClassEntityService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/field-test-service-class-entities/' + 123);
            });
            it('should return FieldTestServiceClassEntity', () => {

                let entity: FieldTestServiceClassEntity;
                service.find(123).subscribe((_entity: FieldTestServiceClassEntity) => {
                    entity = _entity;
                });
