...
describe('Service Tests', () => {
    ...
    describe('FieldTestInfiniteScrollEntity Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FieldTestInfiniteScrollEntityService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/field-test-infinite-scroll-entities/' + 123);
            });
            it('should return FieldTestInfiniteScrollEntity', () => {

                let entity: FieldTestInfiniteScrollEntity;
                service.find(123).subscribe((_entity: FieldTestInfiniteScrollEntity) => {
                    entity = _entity;
                });
