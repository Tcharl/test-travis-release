...
describe('Service Tests', () => {
    ...
    describe('EntityWithDTO Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EntityWithDTOService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/entity-with-dtos/' + 123);
            });
            it('should return EntityWithDTO', () => {

                let entity: EntityWithDTO;
                service.find(123).subscribe((_entity: EntityWithDTO) => {
                    entity = _entity;
                });
