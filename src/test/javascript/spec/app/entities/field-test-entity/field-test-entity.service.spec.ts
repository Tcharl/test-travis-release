...
describe('Service Tests', () => {
    ...
    describe('FieldTestEntity Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FieldTestEntityService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/field-test-entities/' + 123);
            });
            it('should return FieldTestEntity', () => {

                let entity: FieldTestEntity;
                service.find(123).subscribe((_entity: FieldTestEntity) => {
                    entity = _entity;
                });
