...
describe('Service Tests', () => {
    ...
    describe('EntityWithPaginationAndDTO Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EntityWithPaginationAndDTOService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/entity-with-pagination-and-dtos/' + 123);
            });
            it('should return EntityWithPaginationAndDTO', () => {

                let entity: EntityWithPaginationAndDTO;
                service.find(123).subscribe((_entity: EntityWithPaginationAndDTO) => {
                    entity = _entity;
                });
