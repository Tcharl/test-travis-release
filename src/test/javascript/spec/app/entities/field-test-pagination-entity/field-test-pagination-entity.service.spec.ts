...
describe('Service Tests', () => {
    ...
    describe('FieldTestPaginationEntity Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FieldTestPaginationEntityService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/field-test-pagination-entities/' + 123);
            });
            it('should return FieldTestPaginationEntity', () => {

                let entity: FieldTestPaginationEntity;
                service.find(123).subscribe((_entity: FieldTestPaginationEntity) => {
                    entity = _entity;
                });
