...
public class FieldTestMapstructEntityResourceIntTest {
    ...
    public void setup() {
        ...
        final FieldTestMapstructEntityResource fieldTestMapstructEntityResource = new FieldTestMapstructEntityResource(fieldTestMapstructEntityRepository, fieldTestMapstructEntityMapper);
