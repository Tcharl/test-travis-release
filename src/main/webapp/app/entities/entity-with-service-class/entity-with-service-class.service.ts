...
export class EntityWithServiceClassService {
    ...
    /**
     * Convert a returned JSON object to EntityWithServiceClass.
     */
    private convertItemFromServer(json: any): EntityWithServiceClass {
        const entity: EntityWithServiceClass = Object.assign(new EntityWithServiceClass(), json);
        return entity;
    }

    /**
     * Convert a EntityWithServiceClass to a JSON which can be sent to the server.
     */
