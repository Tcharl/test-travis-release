...
export class EntityWithPaginationService {
    ...
    /**
     * Convert a returned JSON object to EntityWithPagination.
     */
    private convertItemFromServer(json: any): EntityWithPagination {
        const entity: EntityWithPagination = Object.assign(new EntityWithPagination(), json);
        return entity;
    }

    /**
     * Convert a EntityWithPagination to a JSON which can be sent to the server.
     */
